          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-2">
              <h1 className="text-4xl font-display font-bold text-foreground flex items-center gap-3">
                <span className="px-3 py-1 rounded-lg bg-[#ffffff1a] text-[40px] text-[#37d633] font-medium">{family.name}</span>
            ...
            <Card className="p-6 border-primary/20 bg-gradient-to-br from-white to-primary/5 shadow-lg">
              <div className="flex justify-between items-end mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold font-display text-[#37d633]">
